...
public class Server extends Thread {
     ...
     */  
     public void initializeAccounts()
     {
        ...
        try
        {
         inputStream = new Scanner(new FileInputStream("/home/anastassy/IdeaProjects/comp_346_assignment_2/src/account.txt"));
        }
...
//                 }
    ...
    public void run() {
        ...
        System.out.println("\n DEBUG : Server.run() - starting server thread " + this.getServerThreadId() + " " + Network.getServerConnectionStatus());

        /* Implement the code for the run method */

        // Get name of the current thread to know which one to disconnect
